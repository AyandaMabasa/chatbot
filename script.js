...
const responses = [
  ...
  { keywords: ["what time", "current time", "tell me the time"], answers: [() => `It's ${new Date().toLocaleTimeString()}`] },
  { keywords: ["what date", "today's date", "date"], answers: [() => `Today is ${new Date().toLocaleDateString()}`] },
